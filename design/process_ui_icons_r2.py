#!/usr/bin/env python3
"""Process round 2 UI icon PNGs → transparent background WebP for the app."""
...
# Round 2: Map input filenames → output filenames
ICONS = {
    "icon-star-full.png": "icon-star-full.webp",
    "icon-star-empty.png": "icon-star-empty.webp",
    "icon-lock.png": "icon-lock.webp",
    "icon-checkmark-circle.png": "icon-check-circle.webp",
    "icon-exit.png": "icon-sign-out.webp",
    "icon-player-add.png": "icon-add-player.webp",
    "icon-caret-right.png": "icon-caret-right.webp",
}
