...
function HomeContent() {
  ...
  return (
    <div className="relative min-h-dvh">
      ...
      <div className="fixed bottom-2 left-2 z-50 bg-black/80 text-white text-[10px] px-2 py-1 rounded font-mono max-w-[250px] break-all">
        outfit: {JSON.stringify(activeChild?.equippedOutfit ?? "no child")}
      </div>
